...
**当前状态：规划、代码骨架、STM32 最小 bring-up，以及 PA0/PA1 + TIM2 的双路 Hall 捕获均已实机完成——PR #65（双路 L1 串扰证据）已合并，捕获固件经 SWD 写入并校验，UART 已记录无脉冲、Hall 1、Hall 2 与复位后双路捕获。逻辑分析仪周期对照、PPR/RPM、PWM、旁路和电机实机验证仍未完成，不具备安全飞行条件。**
...
- [ ] 双路 Hall 逻辑分析仪周期对照、PPR 标定与 RPM 精度验收
- [ ] 硬件型号、电压、协议和引脚确认
