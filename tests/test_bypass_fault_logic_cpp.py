...
CPP_TEST = ROOT / "tests" / "cpp" / "test_bypass_fault_logic.cpp"


class BypassFaultLogicCppTests(unittest.TestCase):
    def test_cpp_host_suite(self):
        with tempfile.TemporaryDirectory() as temporary_directory:
            executable = Path(temporary_directory) / "test_bypass_fault_logic"
            ...
            self.assertIn(
                "Bypass and fault host logic tests passed",
                test_result.stdout,
            )
