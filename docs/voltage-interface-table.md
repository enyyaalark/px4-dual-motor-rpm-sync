...
> 建立日期：2026-08-31
> 状态：A3144E→HC14 单路链路已通过 L1 手动触发与三通道整形验证（1nF 保留为起始值）；最高预期脉冲频率不丢脉冲仍待测
...
- 2026-09-02（Issue #5）：PulseView/sigrok 三通道同步采集（8 逻辑通道、20 kHz；D0=P0/A3144E OUT、D1=P2/HC14 1Y、D2=P1/HC14 1A）。本次供电实测 A3144E VCC 5.00V、HC14 VCC 3.25V；无磁体 P0/P1 3.24V、P2 0V。
- 原始输出 P0 与滤波后输入 P1 同相，整形输出 P2 与二者反相，符合 HC14 反相施密特逻辑；2 颗磁铁手动靠近/离开多次均为单次干净边沿，无毛刺、双沿或丢沿。
...
- 原始波形与采集文件位于 `data/raw/2026-09-02/`（已纳入版本控制）；采样条件：sigrok 0.6.0，8 通道、20 kHz；Issue #4 会话 `2026-09-02_single_hall_manual_magnet.sr`，Issue #5 会话 `2026-09-02_hc14_raw_in_out_manual_1nF.sr`（D0=P0、D1=P2、D2=P1，其余通道未用于本次判定）。
