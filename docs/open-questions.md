...
| Q07 | Hall 捕获已形成 `PA0/PA1 + TIM2_CH1/CH2` 的 CubeMX 配置并经 SWD 写入、UART 双路采集验证；Issue #6 已按修订范围关闭，最高预期频率与数字滤波结论转交 Issue #8；PWM、旁路和最终整机定时器/GPIO 分配仍待验证 | 决定完整 CubeMX 工程与布线 | role:firmware | PWM/旁路固件集成、PPR/RPM |
