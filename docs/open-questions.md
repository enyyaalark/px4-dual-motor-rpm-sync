...
| Q12 | 焊台可用性与核心板排针焊接时间 | 核心板出厂不带排针，`PA9` 遥测、霍尔输入、PWM 捕获/输出和 SWD 均在 100mil 排针孔位上；点灯已可通过 USB DFU 绕过，其余引脚无替代路径 | 两人共同 | T01 UART 验证、单路/双路霍尔捕获、PX4 PWM 捕获、ESC PWM 输出、SWD 调试 |
