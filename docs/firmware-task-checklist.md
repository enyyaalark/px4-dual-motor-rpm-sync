...
- TIM1 双路 PWM 输出已通过逻辑分析仪验证（400Hz、同步）；当前无桨台架范围已更新为 1060–1080µs。
...
主要阻塞：ESC 在旧 1100µs 范围曾出现异常高转速，已按 v2 改为 1060–1080µs 并等待成员 A 逐台复验；Hall 双路 RPM 与 P 同步效果仍待台架复验，M1 的停止归零、
